<img width="803" height="67" alt="Screenshot 2026-05-06 at 12 18 22 AM" src="https://github.com/user-attachments/assets/023512c6-103b-4360-9f9c-cc98ace23ecf" />
...
---
### Inspo: 
I have saw one instagram post where an user play Beautiful Music using an web-based piano from his laptop  , and that hit me that I can make one for myself and where I can customise my own song. Then I went to google and saw an bunch of web-based piano and started taking points from each website that I like the most and added it to my own website. (and the web inspo - [Onlinepianist](https://www.onlinepianist.com/virtual-piano) )

### Why I built it:
For me, it's like an project that I would proud of. I had made this and I can show it to someone else and whenever I am free, I can play it from my laptop and that's it means I like my own web - piano than anyone else, because it requires no signup, no login no ads just open and start playing

---
## Demo Video 

### [Youtube Video Link](https://youtu.be/j3-9xWUII7A)
...
<img width="2036" height="2632" alt="diagram" src="https://github.com/user-attachments/assets/eee14773-ff45-4a3f-b5e3-9f3c996813bb" />

Made Using  - [Gitdiagram](https://gitdiagram.com/)
